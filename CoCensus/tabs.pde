...
float tab1[] = new float[] {
  tabWidthSmall + 4, tabPositionY
};
float tab2[] = new float[] {
  tabWidthSmall + tabWidth + 8, tabPositionY
};
float tab3[] = new float[] {
  tabWidthSmall + 2 * tabWidth + 12, tabPositionY
};
float tab4[] = new float[] {
  tabWidthSmall + 3 * tabWidth + 16, tabPositionY
};
